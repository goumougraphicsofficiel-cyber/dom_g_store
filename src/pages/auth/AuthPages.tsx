...
export function LoginPage(){
 ...
 const [show,setShow]=useState(false),[busy,setBusy]=useState(false),[authMessage,setAuthMessage]=useState<string|null>(null)
